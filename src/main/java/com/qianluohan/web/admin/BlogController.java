package com.qianluohan.web.admin;
...
import com.qianluohan.service.TypeService;
...
public class BlogController {
    ...
    @PostMapping("/blogs")
    public String saveOrUpdate(Blog blog, RedirectAttributes attributes, HttpSession session){
